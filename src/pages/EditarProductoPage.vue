  ...
  <IonPage>
    ...
    <IonContent :fullscreen="true" class="fondo-azul">
      ...
      <div class="botones">
        ...
        <IonButton expand="block" color="success" @click="guardarCambios">Guardar</IonButton>
      </div>
    </IonContent>
  </IonPage>
</template>
...
onMounted(() => {
  ...
  console.log('Cargar producto para editar con ID:', id)
  ...
  form.value = {
    ...
    categoria: 'Alimentos',
    tipos: ['Perros', 'Gatos'],
    descripcion: 'Fórmula equilibrada para mantenimiento diario. Rica en nutrientes esenciales.',
    precio: 25.99,
    stock: 150,
    imagenFile: null,
    imagenPreview:
...
const guardarCambios = () => {
  if (!validar()) return
  console.log('Producto actualizado:', form.value)
